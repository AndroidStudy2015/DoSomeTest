 ...
 */
public class MyLinearLayoutWithMarginAndPadding extends ViewGroup {


    public MyLinearLayoutWithMarginAndPadding(Context context) {
        super(context);
    }

    public MyLinearLayoutWithMarginAndPadding(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyLinearLayoutWithMarginAndPadding(Context context, AttributeSet attrs, int defStyleAttr) {
